...
src/LinkedList/Tests/%.o: ../src/LinkedList/Tests/%.cpp
	...
	g++ -std=c++11 -I"C:\cygwin64\usr\include\boost" -I"C:\Users\Kitty\workspace\C++ Workspace\TestSuiteTest\cute" -O0 -g3 -Wall -c -fmessage-length=0 -fprofile-arcs -ftest-coverage -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
